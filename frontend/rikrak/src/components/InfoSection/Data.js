...
export const homeObjeOne = {
  ...
  description:
    "RikRakCall is built radically different. We left behind slow bulky servers, opting for decentralized peer to peer calling. We engineered a platform with maximum video quality and lowest latency.",
